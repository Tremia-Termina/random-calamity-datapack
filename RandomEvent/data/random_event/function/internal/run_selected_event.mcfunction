...
execute if score #event rc.event matches 30 run function random_event:events/ender_swarm
execute if score #event rc.event matches 31 run function random_event:events/dragon_breath_bloom
execute if score #event rc.event matches 32 run function random_event:events/void_pressure
execute if score #event rc.event matches 33 run function random_event:events/crystal_interference
